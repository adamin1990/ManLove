...
import adamin.toolkits.application.ADApplication;
import adamin.toolkits.log.Logger;

public class ADAppUtil {
    private static final String TAG = ADAppUtil.class.getSimpleName();
    ...
    public static String getAppVersion() {
        String version = "0";
        try {
            Context context = ADApplication.getInstance();
