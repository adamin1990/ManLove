 ...
 * //                  不见满街漂亮妹，哪个归得程序员？
 * //
 * //         Created by LiTao on 2016-02-26-22:16.
 * //         Company: QD24so
...
public class DetailAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        return DetailFragment.instance(detailDatas.get(position));
    }
    ...
    public DetailFragment getDetailFragment(int position){
        return (DetailFragment) getItem(position);
    }
}
