...
import com.adamin.manslove.utils.PermissionHelper;
import com.adamin.manslove.view.MainActivity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private void runApp() {
        //初始化SDK
        AdManager.getInstance(mContext).init("420aecb587def36e", "1dc34ee6c9e962ad");
        //设置开屏
        setupSplashAd();
    }
