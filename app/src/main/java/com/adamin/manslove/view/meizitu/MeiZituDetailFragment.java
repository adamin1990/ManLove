 ...
 * //                  不见满街漂亮妹，哪个归得程序员？
 * //
 * //         Created by LiTao on 2016-03-06-21:20.
 * //         Company: QD24so
 * //         Email: 14846869@qq.com
 * //         WebSite: http://lixiaopeng.top
 * //
 */
public class MeiZituDetailFragment extends Fragment {
    ...
    public static Fragment newInstance(MeiZiTu meizitu, int pos) {
        MeiZituDetailFragment detailFragment = new MeiZituDetailFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable("meizitu", meizitu);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        meiZiTu= (MeiZiTu) getArguments().getSerializable("meizitu");
        pos=getArguments().getInt("pos");
        picasso = new Picasso.Builder(getContext())
                .build();
        picasso.load(meiZiTu.getImgs().get(pos)).
