...
import com.adamin.manslove.domain.HomeDataWrapper;
 ...
 * //                  不见满街漂亮妹，哪个归得程序员？
 * //
 * //         Created by LiTao on 2016-02-23-22:33.
 * //         Company: QD24so
...
public class MainFragmentModelImpl implements MainFragmentModel {
    @Override
    public void fetchDataByNetwork(Object object, final OnMainListener onMainListener,
                                   int page, String pagesize, String keyword, TabModel tabModel) {
        OkHttpUtils.post()
                .url(Constant.BASEURL)
                .tag(object)
                .params(ApiUtils.getAlbumtHomeData(page,pagesize,keyword,tabModel.getId().toString()))
                .build()
    ...
    @Override
    public void fetchMoreData(Object object, OnMainListener onMainListener) {

    }

    @Override
    public void parserData(String response) {
